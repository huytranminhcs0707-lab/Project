                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="product1 hot">
                                    <div class="product2-image new"
                                         style="background-image:url('https://images.unsplash.com/photo-1545324418-cc1a3fa10c00'); background-size:cover; height:200px;"></div>

                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Căn hộ chung cư Sky Park Residence</a>
                                        </div>

                                        <span class="product1-conntent-title">
                Dự án Sky Park Residence nằm tại trung tâm quận Cầu Giấy với
                thiết kế hiện đại, không gian sống xanh và nhiều tiện ích cao cấp.
            </span>
                                    ...
                                    <div class="product1-footer">
                                        ...
                                        <button class="product1-footer-detail">
                                            <a href="./ChiTiet.html" style="color:#fff">Xem chi tiết</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="product1">
                                    <div class="product2-image"
                                         style="background-image:url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab'); background-size:cover; height:200px;"></div>

                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Căn hộ Sunrise City</a>
                                        </div>

                                        <span class="product1-conntent-title">
                Sunrise City là khu căn hộ cao cấp tại Quận 7 với thiết kế
                sang trọng và đầy đủ tiện ích nội khu.
            </span>
                                        ...
                                        <ul class="product1-conntent-list">
                                            ...
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 80m² - 150m²</span>
                                            </li>
                                        </ul>
                                    </div>

                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">3.9 Tỷ</span>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="product1">
                                    <div class="product2-image"
                                         style="background-image:url('https://images.unsplash.com/photo-1502672260266-1c1ef2d93688'); background-size:cover; height:200px;"></div>

                                    <div class="product1-conntent">
                                        <div class="product1-conntent-header">
                                            <a href="">Căn hộ Masteri Thảo Điền</a>
                                        </div>

                                        <span class="product1-conntent-title">
                Masteri Thảo Điền là khu căn hộ cao cấp nằm tại TP Thủ Đức,
                gần trung tâm thương mại Vincom Mega Mall.
            </span>

                                        <ul class="product1-conntent-list">
                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-location-dot"></i>
                                                <span>Thảo Điền, TP Thủ Đức</span>
                                            </li>

                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-building"></i>
                                                <span>Loại BĐS: Chung cư cao cấp</span>
                                            </li>

                                            <li class="product1-conntent-item">
                                                <i class="fa-solid fa-earth-asia"></i>
                                                <span>Diện tích: 65m² - 120m²</span>
                                            </li>
                                        </ul>
                                    </div>

                                    <div class="product1-footer">
                                        <span class="product1-footer-cost">4.2 Tỷ</span>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="product2">
                                ...
                                <div class="product1-image"
                                     style="background-image:url('https://images.unsplash.com/photo-1493809842364-78817add7ffb');
             background-size:cover; height:200px;"></div>

                                <div class="product1-conntent">
                                    <div class="product1-conntent-header">
                                        <a href="">Căn hộ Sala Thủ Thiêm</a>
                                    </div>

                                    <span class="product1-conntent-title">
                Sala Thủ Thiêm là khu căn hộ cao cấp nằm trong khu đô thị
                mới Thủ Thiêm với không gian sống xanh và hiện đại.
            </span>
                                    ...
                                    <ul class="product1-conntent-list">
                                        ...
                                        <li class="product1-conntent-item">
                                            <i class="fa-solid fa-earth-asia"></i>
                                            <span>Diện tích: 70m² - 150m²</span>
                                        </li>
                                    </ul>
                                </div>

                                <div class="product1-footer">
                                    <span class="product1-footer-cost">5.2 Tỷ</span>
                                    <button class="product1-footer-detail">
                                        <a href="./ChiTiet.html" style="color:#fff">Xem chi tiết</a>
                                    </button>
                                </div>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="product2">
                                ...
                                <div class="product1-image"
                                     style="background-image:url('https://images.unsplash.com/photo-1460317442991-0ec209397118');
             background-size:cover; height:200px;"></div>

                                <div class="product1-conntent">
                                    <div class="product1-conntent-header">
                                        <a href="">Căn hộ The Manor</a>
                                    </div>

                                    <span class="product1-conntent-title">
                The Manor được thiết kế theo phong cách châu Âu sang trọng,
                nằm gần trung tâm thành phố và nhiều tiện ích cao cấp.
            </span>
                                    ...
                                    <ul class="product1-conntent-list">
                                        ...
                                        <li class="product1-conntent-item">
                                            <i class="fa-solid fa-earth-asia"></i>
                                            <span>Diện tích: 85m² - 160m²</span>
                                        </li>
                                    </ul>
                                </div>

                                <div class="product1-footer">
                                    <span class="product1-footer-cost">3.7 Tỷ</span>
                                    <button class="product1-footer-detail">
                                        <a href="./ChiTiet.html" style="color:#fff">Xem chi tiết</a>
                                    </button>
                                </div>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="product2">
                                ...
                                <div class="product1-image"
                                     style="background-image:url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab');
             background-size:cover; height:200px;"></div>

                                <div class="product1-conntent">
                                    <div class="product1-conntent-header">
                                        <a href="">Căn hộ Eco Green Sài Gòn</a>
                                    </div>

                                    <span class="product1-conntent-title">
                Eco Green Sài Gòn là khu căn hộ hiện đại với công viên xanh
                rộng lớn và nhiều tiện ích cho cư dân.
            </span>
                        ...
                        <div class="col-12 col-md-3">
                            <div class="product2">
                                ...
                                <div class="product1-image"
                                     style="background-image:url('https://images.unsplash.com/photo-1512917774080-9991f1c4c750');
             background-size:cover; height:200px;"></div>

                                <div class="product1-conntent">
                                    <div class="product1-conntent-header">
                                        <a href="">Căn hộ Empire City</a>
                                    </div>

                                    <span class="product1-conntent-title">
                Empire City là dự án căn hộ cao cấp nằm tại khu đô thị
                Thủ Thiêm với view sông Sài Gòn tuyệt đẹp.
            </span>

                                    <ul class="product1-conntent-list">
                                        <li class="product1-conntent-item">
                                            <i class="fa-solid fa-location-dot"></i>
                                            <span>Thủ Thiêm, TP Thủ Đức</span>
                                        </li>
                                        ...
                                        <li class="product1-conntent-item">
                                            <i class="fa-solid fa-earth-asia"></i>
                                            <span>Diện tích: 90m² - 200m²</span>
                                        </li>
                                    </ul>
                                </div>

                                <div class="product1-footer">
                                    <span class="product1-footer-cost">7.1 Tỷ</span>
                                    <button class="product1-footer-detail">
                                        <a href="./ChiTiet.html" style="color:#fff">Xem chi tiết</a>
                                    </button>
                                </div>
                    ...
                    <div class="row">
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-md-3 d-flex">
                                <div class="product2 d-flex flex-column w-100">

                                    <div class="product1-image"
                                         style="background-image:url('https://images.unsplash.com/photo-1502005229762-cf1b2da7c5d6');
                 background-size:cover;
                 background-position:center;
                 height:200px;">
                                    </div>

                                    <div class="product1-conntent flex-grow-1 p-3">

                                        <div class="product1-conntent-header mb-2">
                                            <a href="">Căn hộ Vinhomes Central Park</a>
                                        </div>

                                        <p class="product1-conntent-title">
                                            Vinhomes Central Park là khu đô thị cao cấp nằm ven sông Sài Gòn
                                            với công viên rộng lớn và hệ thống tiện ích hiện đại.
                                        </p>

                                        <ul class="product1-conntent-list">
                                            <li><i class="fa-solid fa-location-dot"></i> Bình Thạnh, TP.HCM</li>
                                            <li><i class="fa-solid fa-building"></i> Loại BĐS: Chung cư cao cấp</li>
                                            <li><i class="fa-solid fa-earth-asia"></i> Diện tích: 70m² - 140m²</li>
                                        </ul>

                                    </div>

                                    <div class="product1-footer d-flex justify-content-between align-items-center p-3">
                                        <span class="product1-footer-cost">4.5 Tỷ</span>
                                        <a href="./ChiTiet.html" class="btn btn-danger">Xem chi tiết</a>
                                    </div>
                            ...
                            <div class="col-12 col-md-3 d-flex">
                                <div class="product2 d-flex flex-column w-100">
                                    ...
                                    <div class="product1-image"
                                         style="background-image:url('https://images.unsplash.com/photo-1484154218962-a197022b5858');
                 background-size:cover;
                 background-position:center;
                 height:200px;">
                                    </div>
                                    ...
                                    <div class="product1-conntent flex-grow-1 p-3">
                                        ...
                                        <div class="product1-conntent-header mb-2">
                                            <a href="">Căn hộ The Gold View</a>
                                        </div>

                                        <p class="product1-conntent-title">
                                            The Gold View là khu căn hộ hiện đại nằm gần trung tâm thành phố
                                            với hồ bơi, phòng gym và khu mua sắm tiện lợi.
                                        </p>

                                        <ul class="product1-conntent-list">
                                            <li><i class="fa-solid fa-location-dot"></i> Quận 4, TP.HCM</li>
                                            <li><i class="fa-solid fa-building"></i> Loại BĐS: Chung cư</li>
                                            <li><i class="fa-solid fa-earth-asia"></i> Diện tích: 68m² - 120m²</li>
                                        </ul>

                                    </div>

                                    <div class="product1-footer d-flex justify-content-between align-items-center p-3">
                                        <span class="product1-footer-cost">3.6 Tỷ</span>
                                        <a href="./ChiTiet.html" class="btn btn-danger">Xem chi tiết</a>
                                    </div>
                            ...
                            <div class="col-12 col-md-3 d-flex">
                                <div class="product2 d-flex flex-column w-100">
                                    ...
                                    <div class="product1-image"
                                         style="background-image:url('https://images.unsplash.com/photo-1515263487990-61b07816b324');
                 background-size:cover;
                 background-position:center;
                 height:200px;">
                                    </div>
                                    ...
                                    <div class="product1-conntent flex-grow-1 p-3">
                                        ...
                                        <div class="product1-conntent-header mb-2">
                                            <a href="">Căn hộ River Gate Residence</a>
                                        </div>

                                        <p class="product1-conntent-title">
                                            River Gate Residence mang phong cách hiện đại với tầm nhìn
                                            hướng sông và vị trí gần trung tâm quận 1.
                                        </p>

                                        <ul class="product1-conntent-list">
                                            <li><i class="fa-solid fa-location-dot"></i> Bến Vân Đồn, Quận 4</li>
                                            <li><i class="fa-solid fa-building"></i> Loại BĐS: Chung cư cao cấp</li>
                                            <li><i class="fa-solid fa-earth-asia"></i> Diện tích: 60m² - 130m²</li>
                                        </ul>
                            ...
                            <div class="col-12 col-md-3 d-flex">
                                <div class="product2 d-flex flex-column w-100">
                                    ...
                                    <div class="product1-image"
                                         style="background-image:url('https://images.unsplash.com/photo-1494526585095-c41746248156');
                 background-size:cover;
                 background-position:center;
                 height:200px;">
                                    </div>
                                    ...
                                    <div class="product1-conntent flex-grow-1 p-3">
                                        ...
                                        <div class="product1-conntent-header mb-2">
                                            <a href="">Căn hộ Diamond Island</a>
                                        </div>

                                        <p class="product1-conntent-title">
                                            Diamond Island là khu căn hộ cao cấp biệt lập với không gian
                                            sống yên tĩnh và nhiều tiện ích nghỉ dưỡng.
                                        </p>

                                        <ul class="product1-conntent-list">
                                            <li><i class="fa-solid fa-location-dot"></i> Quận 2, TP Thủ Đức</li>
                                            <li><i class="fa-solid fa-building"></i> Loại BĐS: Chung cư cao cấp</li>
                                            <li><i class="fa-solid fa-earth-asia"></i> Diện tích: 85m² - 200m²</li>
                                        </ul>

                                    </div>

                                    <div class="product1-footer d-flex justify-content-between align-items-center p-3">
                                        <span class="product1-footer-cost">6.2 Tỷ</span>
                                        <a href="./ChiTiet.html" class="btn btn-danger">Xem chi tiết</a>
                                    </div>
